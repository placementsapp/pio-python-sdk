"""
python example/opportunity/update_opportunity_dates.py \
    --attributes '{
...
async def update_opportunity_dates(environment: str, token: str, attributes: dict):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Update the start and end date of opportunities."
    )
    parser.add_argument(
        "--environment",
        type=str,
    ...
    asyncio.run(update_opportunity_dates(**vars(args)))
